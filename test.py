...
import sys
sys.path.insert(0, 'detection/mmdetection/tools')
from apis import detect_img
...
def get_face_image(img):
    # get image, cv2 format
    image = detect_img(img, thr=0.1)
    image = image[:, :, (2, 1, 0)]
